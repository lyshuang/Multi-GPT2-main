...
class Trainer:
    def __init__(self, model, train_dataset, trainer_config, writer, logger=None, test_dataset=None, valid_dataset=None,
        ...
        self.linear_schedule = trainer_config.linear_schedule #True
        self.patience = trainer_config.patience  # -1
        ...
        self.full_input = full_input # False
        self.max_length = max_length # 80
        self.max_y_length = max_y_length # 80
        self.new_dataset = new_dataset # False
        self.best_ppl = 1e35
        ...
        self.pointer_gen = pointer_gen #False

        self.model = model.to(device)
        self.uncertainty_loss = uncertainty_loss #False
        ...
        param_optimizer = list(self.model.named_parameters()) #len(param_optimizer)=150
        ...
        if not self.linear_schedule:
            ...
            total_steps = len(train_dataset) * self.n_epochs // self.train_batch_size # 524*5//16=163
            if local_rank != -1:
                total_steps = total_steps // torch.distributed.get_world_size() # 163//1
